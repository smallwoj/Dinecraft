...
class FoodCard {
    constructor(insideElem, menuItem) {
        ...
        var el = $(`
            ...
            <div class="img-wrapper" style="position: relative; margin-left:auto; margin-right:auto; width:100%; margin-bottom:5%;"><img src="./img/expandthis.png" width=100%></div>
            </div>
            </div>
        `);
    ...
    showDetailedStuff()
    {
        ...
        //$(this.ref.find('.additional-details').find('h5')).css('font-size', '1.3rem');
    }
